...
*/}}
{{- define "aks-kube-oidc-proxy.name" -}}
...
*/}}
{{- define "aks-kube-oidc-proxy.fullname" -}}
...
*/}}
{{- define "aks-kube-oidc-proxy.chart" -}}
...
*/}}
{{- define "aks-kube-oidc-proxy.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "aks-kube-oidc-proxy.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
